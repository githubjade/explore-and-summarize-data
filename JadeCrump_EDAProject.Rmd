...
ggplot(data=wine,aes(x=pH, y=sulphates))+
  geom_point(aes(color=newqual), alpha = 1/2, position= 'jitter')+
  xlim(2.75,quantile(wine$pH,0.99))+
  ylim(0.25,quantile(wine$sulphates,0.95))+
  geom_smooth(stat='smooth', fun.y=median, aes(color=newqual))+
  ggtitle('pH & Sulphates by Quality ')
```
